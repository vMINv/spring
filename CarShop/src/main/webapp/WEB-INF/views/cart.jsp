				...
				<form:form name="removeForm" method="put">
					<c:forEach items="${cart.cartItems}" var="item">
						<tr>
							...
							<td><a href="javascript:removecartFunction()" class="btn btn-danger btn-sm">ajax삭제</a></td>
...
<script>
	...
	function clearCart() {
	    document.clearForm.submit(); // form 을 전송하고
	    window.location.reload();    // 새로고침. 리로드.
	}
